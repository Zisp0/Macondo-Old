<?php
    ...
    //Usuario.php
    require_once (__DIR__."/dataSource.php");  //La clase que permite conectarse a la Base de Datos
    ...
    class usuarioDAO {
        ...
        public function autenticarUsuario($correo, $password){
            ...
            $data_table = $data_source->ejecutarConsulta("SELECT * FROM usuario WHERE correo = :correo AND contrasena = :password", array(':correo'=>$correo,':password'=>$password));
        ...
        public function insertarToken($correo, $token){
            $data_source = new dataSource();
            $stmt1 = "UPDATE usuario SET token = '$token' WHERE correo = '$correo'"; 
